...
public class CruiseTicketFactory implements TicketFactory {
    @Override
    public CruiseTicket createTicket(String[] object,int ID) {
        ...
        return new CruiseTicket(ID,departurePoint,destinationPoint,numberOfDays,type,transport,dataStart,dataEnd,numberOfIngestion,nameOfSea);
    }
}
